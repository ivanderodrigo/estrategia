...
SECTION_WEIGHT = {
    # v4.0.1: client intelligence is a first-class research target. Client need/area
    # mapping now outranks ecosystem breadth once the relationship graph is established.
    "clients_public": 1.70,
