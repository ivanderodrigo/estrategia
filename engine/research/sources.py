...
ROUTES = {
    ...
    "financial": (
        "/investors", "/investor", "/investor-relations", "/financials", "/financial-information",
        "/financial-results", "/quarterly-results", "/earnings", "/results", "/annual-report",
        "/annual-reports", "/reports", "/reports-and-filings", "/filings",
        "/company/investors", "/company/investor-relations", "/about/investors",
        "/about-us/investors", "/resultados", "/resultados-financieros",
        "/informacion-financiera", "/relatorio-e-contas", "/relatorios-e-contas",
        "/informacao-financeira", "/sitemap.xml",
    ),
    "news": (
...
PATH_FAMILY_HINTS = {
    ...
    "financial": ("invest", "annual", "result", "relatorio", "financial", "report", "earning", "quarter", "filing", "contas", "financiera", "financeira"),
