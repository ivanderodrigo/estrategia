...
class BusinessIntelligenceV380(unittest.TestCase):
    ...
    def test_frontend_has_accessible_text_scaling(self):
        ...
        js = (ROOT / "assets/v380/intelligence.js").read_text(encoding="utf-8")
        for control in ("textSmaller","textReset","textLarger"):
            self.assertIn(f'id="{control}"', html)
        self.assertIn("--font-scale", (ROOT / "assets/v380/intelligence.css").read_text(encoding="utf-8"))
    ...
    def test_no_advice_vocabulary_in_active_product(self):
        ...
        for rel in ("index.html", "assets/v380/intelligence.js", "data/v38/intelligence.json"):
            self.assertIsNone(pattern.search((ROOT / rel).read_text(encoding="utf-8")), rel)

    def test_exports_follow_web_visual_system(self):
        js = (ROOT / "assets/v380/intelligence.js").read_text(encoding="utf-8")
        css = (ROOT / "assets/v380/intelligence.css").read_text(encoding="utf-8")
        ...
        self.assertIn("Westcon_Iberia_Business_Intelligence_v3.8.0.pptx", js)
        self.assertIn("Westcon_Iberia_Business_Intelligence_v3.8.0.pdf", js)
    ...
    def test_automatic_workflows_validate_v38_and_publish_without_rebase(self):
        ...
        for name in ("research-daily.yml", "research-weekly.yml", "research-monthly.yml"):
            ...
            self.assertIn("tests/test_v380.py", text, name)
            self.assertIn("tests/ui_smoke_v380.js", text, name)
