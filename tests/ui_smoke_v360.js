...
const js = fs.readFileSync(path.join(root, 'assets/v360/intelligence.js'), 'utf8');
const data = JSON.parse(fs.readFileSync(path.join(root, 'data/v36/intelligence.json'), 'utf8'));
...
assert(html.includes('assets/v360/intelligence.js'), 'Falta JS v3.6');
assert(html.includes('assets/v360/intelligence.css'), 'Falta CSS v3.6');
assert(!html.includes('manufacturerRole'), 'Fabricantes no debe tener filtro de filas externas');
assert(js.includes("data/v36/intelligence.json"), 'El frontend no carga el dataset v3.6');
