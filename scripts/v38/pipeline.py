...
from v38.build_intelligence import build as build_public_intelligence
from v38.gap_engine import write_gaps
...
def _merged_source_expansion(root: Path) -> tuple[dict[str, Any], dict[str, Any], dict[str, Any]]:
    ...
    v37_additions = load_json(root / "config/v38/source_additions.json", {})
