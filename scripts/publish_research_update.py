...
allowed=['data/current/intelligence.json','data/current/last_run.json','data/current/relationship_graph.json','data/current/research_gaps.json','data/current/metrics_before_after.json','data/current/coverage_report.json','data/current/source_report.json','data/current/research_learning.json','data/current/research_ledger.json']
