...
from v316.build_intelligence import build,write_snapshot
def run(root:Path,profile:str='daily',foundation_rc:int=0)->dict[str,Any]:
 ...
 path=root/'data/v316/last_run.json';path.write_text(json.dumps(result,ensure_ascii=False,indent=2)+'\n',encoding='utf-8');return result
