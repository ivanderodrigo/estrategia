...
def main():
    ...
    if not args.skip_v33:
        ...
        print(f'v3.17 foundation · investigación {canonical} hasta {foundation}s · fuentes ampliadas',flush=True)
