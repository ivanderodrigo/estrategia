...
def main():
    ...
    (REPO/'VERSION').write_text('3.2.4\n',encoding='utf-8')
    print(f'v3.2.4 aplicada · {changed} archivos copiados.')
    print('Tests: python tests/test_v324_unittest.py')
