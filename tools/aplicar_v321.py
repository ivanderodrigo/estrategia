...
def main():
    ...
    print(f'v3.2.1 aplicada · {changed} archivos copiados (los ya colocados se conservan).')
    print('Tests: python tests/test_v320_unittest.py && python tests/test_v321_unittest.py')
