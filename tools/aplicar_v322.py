...
def main():
    ...
    (REPO/'VERSION').write_text('3.2.2\n',encoding='utf-8')
    print(f'v3.2.2 aplicada · {changed} archivos copiados (los ya colocados se conservan).')
    print('Tests: python tests/test_v320_unittest.py ; python tests/test_v321_unittest.py ; python tests/test_v322_unittest.py')
